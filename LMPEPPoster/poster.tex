...
\begin{figure}
	...
	\begin{subfigure}{.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{../figures/iepoly2spring.pdf}
		\caption{Spring}
		\label{fig:sub1}
	\end{subfigure}%
	\begin{subfigure}{.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{../figures/iepoly2cd_player.pdf}
		\caption{CD Player}
		\label{fig:sub2}
	\end{subfigure}
	\begin{subfigure}{.3\textwidth}
	\centering
		\includegraphics[width=\linewidth]{../figures/iepoly2butterfly.pdf}
	\caption{Butterfly}
	\label{fig:sub2}
\end{subfigure}
