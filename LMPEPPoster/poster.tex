...
\begin{document}
	...
	\begin{columns}
		...
		\block{Comparison to Aberth and Laguerre}{
			...
			Random polynomials are created for Degree=1
			We provide a fair comparison between our modified Laguerre method, the standard Laguerre method, and the Aberth method. 
			\end{minipage}\hfill
