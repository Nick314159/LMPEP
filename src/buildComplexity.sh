...
gfortran $FLAGS environment.f90 util.f90 dslmpep_subroutines.f90  dgelmpep_subroutines.f90 dhslmpep_subroutines.f90 cc_test_driver.f90 -lscalapack-openmpi -llapack -lblas && rm *.mod
