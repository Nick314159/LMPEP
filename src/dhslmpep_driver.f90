...
!save results
WRITE(*,'(20G15.4)') 'DHSLMPEP TIME =', DBLE(clock_stop-clock_start)/DBLE(clock_rate)
...
DEALLOCATE(berr, cond, ferr, er, ei, ncoeff, p)

END PROGRAM dhslmpep_driver
