...
fig, ax = plt.subplots()
ax.semilogy(degree, ltimeDegree, 'k-*', label='Laguerre Time')
ax.semilogy(degree, eatimeDegree, 'k--', label='Ehrlich-Aberth Time')
...
fig, ax = plt.subplots()
ax.semilogy(size, ltimeSize, 'k-*', label='Laguerre Time')
ax.semilogy(size, eatimeSize, 'k--', label='Ehrlich-Aberth Time')
ax.set_ylabel('Seconds')
ax.set_xlabel('Size')
legend = ax.legend(loc=0, shadow=True)
