...
fig, ax = plt.subplots()
ax.semilogy(degree1, dsTime, 'k-*', label='DSLMPEP')
ax.semilogy(degree1, pzTime, 'k-.', label='PZEROS')
ax.semilogy(degree2, amTime, 'k--', label='AMVW')
...
fig, ax = plt.subplots()
ax.semilogy(degree1, dsRad, 'k-*', label='DSLMPEP')
ax.semilogy(degree1, pzRad, 'k-.', label='PZEROS')
ax.semilogy(degree2, amRad, 'k--', label='AMVW')
