...
cd ../src
gfortran $FLAGS ../environment.f90 util.f90 dslmpep_subroutines_test.f90 dgelmpep_subroutines_test.f90 dgeeam_subroutines_test.f90 ge_test_driver.f90 -lscalapack-openmpi -llapack -lblas && rm *.mod
