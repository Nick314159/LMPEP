...
cd ../src
gfortran $FLAGS environment.f90 util.f90 ../../src/dslmpep_subroutines.f90 ../../src/dgelmpep_subroutines.f90 ie_test_driver1.f90 -lscalapack-openmpi -llapack -lblas && rm *.mod
